 ...
 *  @brief quadratic probing implementation
 *  @date 4.12.21 */
...
namespace {
  ...
  bool IsPrime(size_t n) {
    ...
    // Default code recieved warning for use of int. Corrected to size_t:
...
class HashTable {
 ...
 private:        
   ...
   *  Insert, quadratic implementation. 
   *  @param x will be inserted with a quadratic algorithm, so our
   *  offset will increment for each probe. */
